...
import fr.uge.manifest.Passager;
...
public class Application {
	static void main() {
	  ...
	  var passenger1 = new Passager("Nicolas F", "France");
	  ...
	  manifest3.add(new Passager("Jane D", "US"));
	  ...
	  ///*/
	    ...
	    manifest4.add(new Passager("Ana K","Russia"));
	    ...
	    manifest5.add(new Passager("James Bond", "UK"));
	    manifest5.add(new Passager("James Bfond", "Iceland"));

	    var manifest6 = new Manifest();
	    manifest6.add(new Container("HLLY 3(45678 5", 30, "Slovenia"));
