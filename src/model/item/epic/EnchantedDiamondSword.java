...
/**
 * Represents an EnchantedDiamondSword item in the game.
 * 
 * An EnchantedDiamondSword has a position (defined by its shape and coordinates),
 * a direction, a durability value, and item statistics. It implements the Item interface,
 * allowing it to be placed in the backpack, rotated, and interact with game mechanics.
 * 
 * Typically used as a high-damage weapon with special effects or synergies.
 * 
...
public record EnchantedDiamondSword(XY[] shape, Direction direction, int durability, ItemStats info) implements Item{
	...
	private static final int ID_VALUE = 17;
  ...
  private static XY[] initShape(XY coord, Direction direction) {
    ...
    b[1] = new XY(coord.x() + 1, coord.y() - 1);
  ...
  @Override
  public EnchantedDiamondSword rotateXY() {
    return new EnchantedDiamondSword(rotate90(shape(), shape()[0]), direction.next(), durability);
  }
