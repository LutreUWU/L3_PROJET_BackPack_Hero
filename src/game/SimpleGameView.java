 ...
 *
 */
public record SimpleGameView(int width, int height, int grid_size) {	
	 ...
	 */
	public static SimpleGameView initGameGraphics(int width, int height, int grid_size) {
		return new SimpleGameView(width, height, grid_size);
	}
	 ...
	 */	
	private static void drawGrid(ApplicationContext context, SimpleGameData data) {
	 ...
	 * @param data	  Data of the game
	 */
	private static void drawItemBag(ApplicationContext context, SimpleGameData data) {
	 ...
	 * @param data	  Data of the game
	 */
	private static void drawWeaponGrid(ApplicationContext context, SimpleGameData data) {
	 ...
	 * 
	 */
	private static void drawHero(ApplicationContext context, SimpleGameData data) {
		 //TO DO 
	}
	 ...
	 * @param data     GameData containing the game data.
	 */	
	public static void updateWeaponDraw(ApplicationContext context, SimpleGameData data) {
		Objects.requireNonNull(context);
		Objects.requireNonNull(data);
